...
ChesWx (Chesapeake Bay Weather) grid contains daily data for precipitation and temperature observations for the Chesapeake Bay watershed and the broader Mid-Atlantic regions.  `cwxr` is the R library package written completely with R language for this ChesWx datasets. It was developed for the [Mid-Atlantic Regional Integrated Sciences and Assessments](https://www.marisa.psu.edu/about/) project. It  can be downloaded from the following directory:
...
Following Steps are required to run the complete cheswx database.

![image](https://user-images.githubusercontent.com/18476138/145078219-987b3442-b9f3-489b-9c5f-8277029d8743.png)
